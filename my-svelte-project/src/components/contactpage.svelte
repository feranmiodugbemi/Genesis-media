...
<div class="flex flex-col w-64 h-screen py-8 bg-white border-r dark:bg-gray-900 dark:border-gray-700 row spllit lleft ">
  <div class="h-screen sticky top-0">
    <div class="flex items-center justify-center h-20 shadow-md">
      <h1 class="text-3xl uppercase text-indigo-500">Genesis</h1>
    </div>
    ...
    <div class="flex flex-col items-center mt-6 -mx-2">
        ...
        <h4 class="mx-2 mt-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">{name}</h4>
...
<div class="spllit rright text-center">
        Hello
  </div>
