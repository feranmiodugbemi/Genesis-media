...
function HandleLogin(){
    ...
    .then(res => {
                    ...
                    if(token){window.location.href='/#/me'}
                })
...
<div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
    ...
    <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
        <h2 class="text-2xl font-semibold uppercase text-center text-indigo-500 dark:text-white">
            Genesis
        </h2>
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <div class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">or login
                with email</div>
      ...
      <form on:submit|preventDefault={HandleLogin}>
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <a href="/#/signup" class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign up</a>
